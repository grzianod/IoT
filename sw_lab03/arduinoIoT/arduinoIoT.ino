...
void setup() {
  ...
  p.begin("python3");
  p.addParameter("/root/sw_lab03/esercizio4.py");
  p.runAsynchronously();
...
void loop() {
  ...
  String senML = "{ \"bn\":\"arduinoYun\", \"e\": [ {\"n\":\"temperature\", \"v\":"+String(temp,2)+",\"u\":\"C\" }, {\"n\":\"fan\", \"v\":"+String(fan_percentage,2)+",\"u\":\"%\" }, {\"n\":\"heat\", \"v\":"+String(heater_percentage,2)+",\"u\":\"C\" } ] }";
  Serial.flush();
